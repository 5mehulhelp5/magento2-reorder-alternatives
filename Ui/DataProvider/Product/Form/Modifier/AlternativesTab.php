<?php
namespace Elgentos\ReorderAlternatives\Ui\DataProvider\Product\Form\Modifier;
...
class AlternativesTab extends AbstractModifier
{
    const DATA_SCOPE_CUSTOM = 'alternatives';
    const GROUP_CUSTOM = 'alternatives';
    ...
    public function __construct(
        ...
        private readonly \Magento\Catalog\Model\ProductFactory $_productloader,
    ...
    {
        $content = __(
            'Alternative products are shown to customers when they reorder an order where not all items are available.'
        );
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => __('Add Alternative Products'),
                        'collapsible' => false,
                        'componentType' => Fieldset::NAME,
                        'dataScope' => '',
                        'sortOrder' => 10,
